...
export function NexterPage() {
  ...
  return (
    <div className="mx-auto grid min-h-[calc(100dvh-8rem)] w-full max-w-6xl overflow-x-hidden gap-2 lg:grid-cols-[minmax(280px,360px)_minmax(0,1fr)] lg:items-start lg:gap-6">
      <div className="nexter-hero flex flex-col items-center overflow-visible px-2 pt-0 sm:rounded-2xl sm:border sm:border-white/10 sm:bg-black/30 sm:px-4 sm:pb-4 sm:pt-3">
        <div className="nexter-orb-stage h-[9.5rem] w-[9.5rem] sm:h-[12.25rem] sm:w-[12.25rem] lg:h-[17rem] lg:w-[17rem]">
