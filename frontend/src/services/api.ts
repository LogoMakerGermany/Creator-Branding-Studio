...
async function request<T>(endpoint: string, options?: RequestInit): Promise<T> {
  ...
  if (!data.success) {
    ...
    const friendly: Record<string, string> = {
      ...
      VIDEO_INVALID_PAYLOAD: 'Das KI-Video konnte nicht verarbeitet werden. Coins wurden erstattet.',
      VIDEO_DOWNLOAD_TIMEOUT: 'Das KI-Video konnte nicht geladen werden. Coins wurden erstattet.',
      VIDEO_STORAGE_ERROR: 'Das KI-Video konnte nicht gespeichert werden. Coins wurden erstattet.',
      VIDEO_PROVIDER_FAILED: 'Die KI-Videogenerierung ist fehlgeschlagen. Coins wurden erstattet.',
      VIDEO_PROVIDER_TIMEOUT: 'Die KI-Videogenerierung ist fehlgeschlagen. Coins wurden erstattet.',
