export enum ModuleId {
  ...
  STREAMSET_STUDIO = 'streamset-studio',
  ANIMATION_STUDIO = 'animation-studio',
  SHORTS_STUDIO = 'shorts-studio',
  SOCIAL_STUDIO = 'social-studio',
  TEXT_STUDIO = 'text-studio',
  MOCKUP_STUDIO = 'mockup-studio',
  TEMPLATES = 'templates',
  ADMIN = 'admin',
}
...
export const MODULES: ModuleDefinition[] = [
  ...
  },
  {
    ...
    name: 'Nexter Assistent',
    description: 'Persönlicher KI-Assistent für Branding und Steuerung',
    icon: 'Bot',
    path: '/nexter',
    phase: 2,
    category: 'ai',
  ...
  {
    id: ModuleId.STREAMSET_STUDIO,
    name: 'Streamset Studio',
    description: 'Komplettes Twitch-/YouTube-Set aus Logo und Creator DNA',
    icon: 'Layers',
    path: '/streamset-studio',
    phase: 1,
    category: 'studio',
  },
  {
    id: ModuleId.ANIMATION_STUDIO,
    name: 'Animation Studio',
    description: 'Intros, Outros, Stinger und Logo-Loops',
    icon: 'Play',
  ...
  {
    id: ModuleId.SHORTS_STUDIO,
    name: 'Shorts Studio',
    description: 'Highlights als 9:16 Clips für TikTok, Shorts und Reels',
    icon: 'Smartphone',
    path: '/shorts-studio',
    phase: 3,
    category: 'studio',
  ...
  {
    id: ModuleId.SOCIAL_STUDIO,
    name: 'Social Studio',
    description: 'Thumbnails, Posts und Story-Grafiken aus der DNA',
    icon: 'Share2',
    path: '/social-studio',
    phase: 4,
    category: 'social',
  ...
  {
    id: ModuleId.TEXT_STUDIO,
    name: 'Text Studio',
    description: 'Titel, Captions, Hooks, Bios und Skripte',
    icon: 'FileText',
    path: '/text-studio',
    phase: 2,
    category: 'ai',
  ...
  {
    id: ModuleId.MOCKUP_STUDIO,
    name: 'Mockup Studio',
    description: 'Design auf Tassen, Shirts und realen Produkten sehen',
    icon: 'Shirt',
    path: '/mockup-studio',
    phase: 1,
    category: 'studio',
  ...
  {
    id: ModuleId.TEMPLATES,
    name: 'Vorlagen',
    description: 'DNA-basierte Startvorlagen für alle Studios',
    icon: 'LayoutTemplate',
    path: '/templates',
    phase: 1,
    category: 'core',
  },
  {
    id: ModuleId.ADMIN,
    name: 'Admin',
    description: 'User, Coins, Kosten und Systemstatus',
    icon: 'Shield',
    path: '/admin',
    phase: 1,
    category: 'core',
